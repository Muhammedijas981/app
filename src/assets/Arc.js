/*
 This file was adapted directly from Obloador's node module react-native-progress
 The most latest and updated version of this can be found at https://github.com/oblador/react-native-progress/blob/master/Shapes/Arc.js
 We aren't using the complete module in this project as we don't need all the components in it
*/
...
export default class Arc extends Component {
  static propTypes = {
    ...
    endAngle: PropTypes.number, // in radians
